<template>
    <div>
        <div id="mian" style="width:300px;height:300px;">
        </div>
        <div id="shen" style="width:300px;height:300px;">
        </div>
    </div>
</template>
...
export default {
    name:'chart_00',
    mounted(){
        var myChart = this.$echarts.init(document.getElementById('mian'))
        var geoCoordMap = {
    	    '上海': [121.4648,31.2891],
    	    '东莞': [113.8953,22.901],
    	    '东营': [118.7073,37.5513],
    	...
    	var planePath = 'path://M1705.0449,1318.313v-89.254l-319.9-221.799l0.073-208.063c0.521-84.662-26.629-121.796-63.961-121.491c-37.332-0.305-64.482,36.829-63.961,121.491l0.073,208.063l-319.9,221.799v89.254l330.343-157.288l12.238,241.308l-134.449,92.931l0.531,42.034l175.125-42.917l175.125,42.917l0.531-42.034l-134.449-92.931l12.238-241.308L1705.06,1318.313z';
    	//var planePath = 'arrow';
 ...
 var myChart1 = this.$echarts.init(document.getElementById('shen'))
